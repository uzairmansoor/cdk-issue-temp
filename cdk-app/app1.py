...
cdkAppStack = CdkAppStack(app, "cdk-old-app", env=primary_env)

lambda_stack = LambdaStack(app, 'lambda-old-stack', ssm_parameters=cdkAppStack.ssm_parameters, env=primary_env)
